        ...
        <div class="overflow-x-auto relative shadow-md sm:rounded-lg">
            <div class="flex justify-between items-center pb-4 bg-white bg-gray-200">
                ...
                <div  class="flex justify-between items-center pb-4 bg-gray-200  ">
                    <a href="#" data-modal-toggle="NewPostBooking" class="mr-3 font-sans text-zinc-50 bg-slate-900 hover:bg-slate-700
                ...
                <tr class="bg-white border-b dark:bg-gray-400 dark:border-gray-500 hover:bg-gray-50 dark:hover:bg-gray-300">
                    <td class="p-4 w-4">
                        <div class="flex items-center">
                            <kbd class="px-2 py-1.5 text-xs font-semibold dark:text-black bg-gray-100 border border-gray-200 rounded-lg dark:bg-gray-600 dark:text-black dark:border-gray-500">1</kbd>
                        </div>
                    </td>
                    ...
                    <td class="py-4 px-6 text-gray-900">
                        <div class="flex items-center">
                            @foreach($categories as $cat)
                                @if($cat->id == $bo->category_gallery_id)
                                    {{$cat->category_name}}
                                @endif
                            @endforeach
                        </div>
...
{{--                        <a  data-modal-toggle="Edit{{$bo->id}}" class=" text-white bg-gray-800 hover:bg-gray-900 focus:outline-none focus:ring-4 focus:ring-gray-300 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2 dark:bg-gray-800 dark:hover:bg-gray-700 dark:focus:ring-gray-700 dark:border-gray-700">Edit</a>--}}
{{--                    </td>--}}
                    <td class="py-4 px-6 text-center">
                        <form action="{{route('bookings.destroy', $bo -> id)}}" method="POST">
                            @csrf
                            @method('DELETE')
        ...
        <div id="NewPostBooking" tabindex="-1" aria-hidden="true" class="hidden overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 justify-center items-center p-4 w-full md:inset-0 h-modal md:h-full">
            <div class="relative w-full max-w-2xl h-full md:h-auto">
                ...
                <form action="#" class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                    ...
                    <div class="flex justify-between items-start p-4 rounded-t border-b dark:border-gray-600">
                        ...
                        <button type="button" data-modal-toggle="NewPostBooking" class="text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm p-1.5 ml-auto inline-flex items-center dark:hover:bg-gray-600 dark:hover:text-white" data-modal-toggle="editUserModal">
    ...
    {{--                            <select id="kategori" class="bg-white border border-white-300 text-white-400 text-sm rounded-lg focus:ring-black-200 focus:border-white-300 block w-full p-2.5 dark:bg-white-700 dark:border-white-600 dark:placeholder-white-400 dark:text-black dark:focus:ring-black-700 dark:focus:border-black-500">--}}
    ...
    {{--                            </select>--}}
                            ...
                            <div class="col-span-12 sm:col-span-6">
                                ...
                                <div class="mt-1 text-sm text-black dark:text-black-300" id="image">Upload Image !</div>
                            </div>
                        </div>
                    </div>
                    <!-- Modal footer -->
...
{{--    @foreach($booking as $bo)--}}
{{--        <div id="Edit{{$bo->id}}" data-modal-backdrop="static"   tabindex="-1" aria-hidden="true" class="hidden overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 justify-center items-center p-4 w-full md:inset-0 h-modal md:h-full">--}}
{{--            <div class="relative w-full max-w-2xl h-full md:h-auto">--}}
{{--                <!-- Modal content -->--}}
{{--                <form action="{{route('galleries.show', $bo->id)}}" method="post" class="relative bg-white rounded-lg shadow dark:bg-gray-700" enctype="multipart/form-data">--}}
{{--                    @csrf--}}
{{--                    @method('PUT')--}}
{{--                    <!-- Modal header -->--}}
{{--                    <div class="flex justify-between items-start p-4 rounded-t border-b dark:border-gray-600">--}}
...
{{--                            Edit Gallery--}}
{{--                        </h3>--}}
{{--                        <button type="button" data-modal-toggle="Edit{{$bo->id}}" class="text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm p-1.5 ml-auto inline-flex items-center dark:hover:bg-gray-600 dark:hover:text-white" >--}}
{{--                            <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M4.293 4.293a1 1 0 011.414 0L10 8.586l4.293-4.293a1 1 0 111.414 1.414L11.414 10l4.293 4.293a1 1 0 01-1.414 1.414L10 11.414l-4.293 4.293a1 1 0 01-1.414-1.414L8.586 10 4.293 5.707a1 1 0 010-1.414z" clip-rule="evenodd"></path></svg>--}}
{{--                        </button>--}}
{{--                    </div>--}}
{{--                    <!-- Modal body -->--}}
...
{{--                                    <img src="{{asset('storage/'.$gal->gallery_file)}}" class="py-2" alt="">--}}
{{--                                </div>--}}
